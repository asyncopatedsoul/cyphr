class RankingsController < ApplicationController
  ...
  private
    ...
    def ranking_params
      params.require(:ranking).permit(:player_id, :group_id, :game_id, :game_metadata, :elo_score, :match_count, :win_ratio, :win_count, :loss_count, :match_id_list, :scope_group_id)
    end
end
